  ...
  if (!fReadOnly)
    {
      ...
      if (strFile == walletPath)
        nMinutes = 0;
// AUX_STORAGE_VERSION3
// AUX_STORAGE_VERSION4
      else if ((strFile == "blkindex.dat" || strFile == "game.dat" || strFile == "game_sv3.dat" || strFile == "game_sv4.dat"
...
// AUX_STORAGE_VERSION3
// AUX_STORAGE_VERSION4
                if ((strFile != "blkindex.dat" && strFile != "addr.dat" && strFile != "game.dat" && strFile != "game_sv3.dat" && strFile != "game_sv4.dat"
